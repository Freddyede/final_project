...
class __TwigTemplate_460536a8ea05d3f6ad0b2499347e55b2 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <div class=\"metrics\">
        ...
        ";
        // line 60
        if ((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["profile"] ?? null), "children", [], "any", false, false, false, 60)) > 0)) {
            // line 61
            ...
            // line 65
            echo (((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["profile"] ?? null), "children", [], "any", false, false, false, 65)) > 1)) ? ("s") : (""));
            echo "</span>
            </div>
            ...
            echo " <span class=\"unit\">ms</span></span>
                <span class=\"label\">Sub-Request";
            // line 79
            echo (((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["profile"] ?? null), "children", [], "any", false, false, false, 79)) > 1)) ? ("s") : (""));
            echo " time</span>
            </div>
        ";
        }
...
";
    ...
    events: [ ";
            // line 161
            echo twig_call_macro($macros["__internal_parse_2"], "macro_dump_events", [($context["events"] ?? null)], 161, $context, $this->getSourceContext());
            echo " ],
}
";
...
{% endmacro %}
", "@WebProfiler/Collector/time.html.twig", "/home/kali/Bureau/final_project/project_final/vendor/symfony/web-profiler-bundle/Resources/views/Collector/time.html.twig");
    }
}
