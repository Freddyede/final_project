...
class __TwigTemplate_7a954fd23f1b50d29948900e0883e1b3 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <span class=\"label ";
        // line 70
        echo ((twig_test_empty(twig_get_attribute($this->env, $this->source, ($context["events"] ?? null), "messages", [], "any", false, false, false, 70))) ? ("disabled") : (""));
        echo "\">
        <span class=\"icon\">";
        // line 71
    ...
    <div class=\"metrics\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["transport"]) {
            ...
            echo "</span>
                <span class=\"label\">";
            // line 97
            echo (((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["events"] ?? null), "messages", [0 => $context["transport"]], "method", false, false, false, 97)) == 1)) ? ("message") : ("messages"));
            echo "</span>
            </div>
        ";
        }
